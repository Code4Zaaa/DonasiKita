...
public class CategoryRepository {
    ...
    public List<Category> getSampleCategories() {
        ...
        categories.add(new Category(1, "📚", "Pendidikan", "pendidikan"));
        categories.add(new Category(2, "🏥", "Kesehatan", "kesehatan"));
        categories.add(new Category(3, "🌍", "Lingkungan", "lingkungan"));
        categories.add(new Category(4, "🤝", "Sosial", "sosial"));
        categories.add(new Category(5, "🐾", "Hewan", "hewan"));
        return categories;
    }
}